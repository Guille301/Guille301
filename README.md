## Desarrollador Full Stack | .NET | React | Angular | Python

Desarrollo aplicaciones web y productos SaaS con foco en backend, frontend e integración de sistemas. He trabajado en proyectos b2c y plataformas de gestión orientadas a empresas.

Stack principal: C#, .NET, React, Angular, Java, Python, SQL y Git.

En este perfil encontrarás proyectos personales y profesionales, documentación técnica y ejemplos de implementación.
